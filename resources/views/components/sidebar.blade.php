<div class="w-64 h-screen bg-green-800 text-white fixed">
    ...
    <nav class="mt-4">
        ...
        <a href="{{ route('stock.index') }}" class=" flex items-center justify-center rounded-[20px] mx-4 bg-white text-black font-semibold block py-2.5 px-4 mb-2 hover:bg-gray-400 {{ request()->routeIs('stock.index') ? 'bg-gray-700' : '' }}">Stock</a>
        <a href="{{ route('hutang.index') }}" class=" flex items-center justify-center rounded-[20px] mx-4 bg-white text-black font-semibold block py-2.5 px-4 mb-2 hover:bg-gray-400 {{ request()->routeIs('hutang.index') ? 'bg-gray-700' : '' }}">Hutang</a>
